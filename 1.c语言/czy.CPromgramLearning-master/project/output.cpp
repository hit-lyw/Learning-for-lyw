...
void testFunc_haizei_add();__attribute__((constructor))void add_haizei_testFunc_haizei_add() { add_function(testFunc_haizei_add, "testFunc" "." "add");}void testFunc_haizei_add() {
    { __typeof(add(5, 3)) _a = (add(5, 3)); __typeof(8) _b = (8); haizei_test_info.total += 1; if (_a == _b) { haizei_test_info.success += 1; } else { printf("\n"); printf("\033[1;" "33" "m" "\t%s : %d : Failure\n" "\033[0m", "main.cpp", 20); printf("\033[1;" "33" "m" "\t\texpect :" "add(5, 3)" " " "==" " " "8" " actual : " "\033[0m"); { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_a), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _a);}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((" vs "), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, " vs ");}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_b), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _b);}; printf("\n"); } printf("\033[" "32" "m" "[-----------] " "\033[0m" "add(5, 3)" " " "==" " " "8"); printf(" %s\n", (add(5, 3)) == (8) ? "\033[1;" "32" "m" "TRUE" "\033[0m" : "\033[1;" "31" "m" "FALSE" "\033[0m");};
    { __typeof(add(5, 3)) _a = (add(5, 3)); __typeof(9) _b = (9); haizei_test_info.total += 1; if (_a != _b) { haizei_test_info.success += 1; } else { printf("\n"); printf("\033[1;" "33" "m" "\t%s : %d : Failure\n" "\033[0m", "main.cpp", 21); printf("\033[1;" "33" "m" "\t\texpect :" "add(5, 3)" " " "!=" " " "9" " actual : " "\033[0m"); { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_a), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _a);}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((" vs "), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, " vs ");}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_b), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _b);}; printf("\n"); } printf("\033[" "32" "m" "[-----------] " "\033[0m" "add(5, 3)" " " "!=" " " "9"); printf(" %s\n", (add(5, 3)) != (9) ? "\033[1;" "32" "m" "TRUE" "\033[0m" : "\033[1;" "31" "m" "FALSE" "\033[0m");};
    { __typeof(add(6, 7)) _a = (add(6, 7)); __typeof(10) _b = (10); haizei_test_info.total += 1; if (_a > _b) { haizei_test_info.success += 1; } else { printf("\n"); printf("\033[1;" "33" "m" "\t%s : %d : Failure\n" "\033[0m", "main.cpp", 22); printf("\033[1;" "33" "m" "\t\texpect :" "add(6, 7)" " " ">" " " "10" " actual : " "\033[0m"); { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_a), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _a);}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((" vs "), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, " vs ");}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_b), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _b);}; printf("\n"); } printf("\033[" "32" "m" "[-----------] " "\033[0m" "add(6, 7)" " " ">" " " "10"); printf(" %s\n", (add(6, 7)) > (10) ? "\033[1;" "32" "m" "TRUE" "\033[0m" : "\033[1;" "31" "m" "FALSE" "\033[0m");};
    { __typeof(add(6, 7)) _a = (add(6, 7)); __typeof(13) _b = (13); haizei_test_info.total += 1; if (_a <= _b) { haizei_test_info.success += 1; } else { printf("\n"); printf("\033[1;" "33" "m" "\t%s : %d : Failure\n" "\033[0m", "main.cpp", 23); printf("\033[1;" "33" "m" "\t\texpect :" "add(6, 7)" " " "<=" " " "13" " actual : " "\033[0m"); { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_a), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _a);}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((" vs "), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, " vs ");}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_b), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _b);}; printf("\n"); } printf("\033[" "32" "m" "[-----------] " "\033[0m" "add(6, 7)" " " "<=" " " "13"); printf(" %s\n", (add(6, 7)) <= (13) ? "\033[1;" "32" "m" "TRUE" "\033[0m" : "\033[1;" "31" "m" "FALSE" "\033[0m");};
    { __typeof(add(6, 7)) _a = (add(6, 7)); __typeof(20) _b = (20); haizei_test_info.total += 1; if (_a > _b) { haizei_test_info.success += 1; } else { printf("\n"); printf("\033[1;" "33" "m" "\t%s : %d : Failure\n" "\033[0m", "main.cpp", 24); printf("\033[1;" "33" "m" "\t\texpect :" "add(6, 7)" " " ">" " " "20" " actual : " "\033[0m"); { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_a), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _a);}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((" vs "), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, " vs ");}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_b), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _b);}; printf("\n"); } printf("\033[" "32" "m" "[-----------] " "\033[0m" "add(6, 7)" " " ">" " " "20"); printf(" %s\n", (add(6, 7)) > (20) ? "\033[1;" "32" "m" "TRUE" "\033[0m" : "\033[1;" "31" "m" "FALSE" "\033[0m");};
}

void testFunc_haizei_add2();__attribute__((constructor))void add_haizei_testFunc_haizei_add2() { add_function(testFunc_haizei_add2, "testFunc" "." "add2");}

void testFunc_haizei_add2() {
    { __typeof(add(5, 3)) _a = (add(5, 3)); __typeof(8) _b = (8); haizei_test_info.total += 1; if (_a == _b) { haizei_test_info.success += 1; } else { printf("\n"); printf("\033[1;" "33" "m" "\t%s : %d : Failure\n" "\033[0m", "main.cpp", 28); printf("\033[1;" "33" "m" "\t\texpect :" "add(5, 3)" " " "==" " " "8" " actual : " "\033[0m"); { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_a), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _a);}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((" vs "), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, " vs ");}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_b), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _b);}; printf("\n"); } printf("\033[" "32" "m" "[-----------] " "\033[0m" "add(5, 3)" " " "==" " " "8"); printf(" %s\n", (add(5, 3)) == (8) ? "\033[1;" "32" "m" "TRUE" "\033[0m" : "\033[1;" "31" "m" "FALSE" "\033[0m");};
    { __typeof(add(5, 4)) _a = (add(5, 4)); __typeof(9) _b = (9); haizei_test_info.total += 1; if (_a == _b) { haizei_test_info.success += 1; } else { printf("\n"); printf("\033[1;" "33" "m" "\t%s : %d : Failure\n" "\033[0m", "main.cpp", 29); printf("\033[1;" "33" "m" "\t\texpect :" "add(5, 4)" " " "==" " " "9" " actual : " "\033[0m"); { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_a), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _a);}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((" vs "), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, " vs ");}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_b), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _b);}; printf("\n"); } printf("\033[" "32" "m" "[-----------] " "\033[0m" "add(5, 4)" " " "==" " " "9"); printf(" %s\n", (add(5, 4)) == (9) ? "\033[1;" "32" "m" "TRUE" "\033[0m" : "\033[1;" "31" "m" "FALSE" "\033[0m");};
    { __typeof(add(6, 7)) _a = (add(6, 7)); __typeof(13) _b = (13); haizei_test_info.total += 1; if (_a == _b) { haizei_test_info.success += 1; } else { printf("\n"); printf("\033[1;" "33" "m" "\t%s : %d : Failure\n" "\033[0m", "main.cpp", 30); printf("\033[1;" "33" "m" "\t\texpect :" "add(6, 7)" " " "==" " " "13" " actual : " "\033[0m"); { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_a), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _a);}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((" vs "), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, " vs ");}; { char frm[1000]; sprintf(frm, "\033[1;" "33" "m" "%s" "\033[0m", _Generic((_b), int : "%d", double : "%lf", float : "%f", long long : "%lld", const char * : "%s")); printf(frm, _b);}; printf("\n"); } printf("\033[" "32" "m" "[-----------] " "\033[0m" "add(6, 7)" " " "==" " " "13"); printf(" %s\n", (add(6, 7)) == (13) ? "\033[1;" "32" "m" "TRUE" "\033[0m" : "\033[1;" "31" "m" "FALSE" "\033[0m");};
}
